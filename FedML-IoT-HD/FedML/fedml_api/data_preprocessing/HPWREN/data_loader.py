...
def get_HPWREN_dataloader(batch_size,dataset_dir):
    (
        client_num,
        train_data_num,
        test_data_num,
        ...
        test_data_local_dict,
        output_dim,
    ) = load_partition_data_HPWREN(batch_size,dataset_dir)

    train_loaders = []
    test_loaders = []

    test_data_global = HPWREN_loader(test_data_global)

    for loader_idx in range(client_num):
        train_loaders.append(HPWREN_loader(train_data_local_dict[loader_idx]))
        test_loaders.append(HPWREN_loader(test_data_local_dict[loader_idx]))
